...
class ModelState internal constructor(val modelPath: String) {
    ...
    suspend fun initialize() {
        //Trace.log("I1: initialize($modelPath) ENTER")
        ...
        mutex.withLock {
            ...
            try {
                ...
                //Trace.log("Calling conduit_llm_get_session") ////
                val session = LlmPortal.initialize(absPath)
                //Trace.log("Exited conduit_llm_get_session")

                setSession(session)
                //Trace.log("set session done initialize($modelPath) ENTER")

                updateStatus(ModelStatus.READY)
                //Trace.log("updateStatus done initialize($modelPath) ENTER")
        ...
        //Trace.log("AppState.initialize($modelPath) finished") ////
    }
